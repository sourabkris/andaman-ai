  ...
  return (
    <section aria-label="Chat and itinerary generator" className="flex flex-col h-full basis-0 flex-grow rounded-xl border border-gray-200 overflow-hidden bg-white shadow-sm">
      <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-4" aria-live="polite">
        ...
        {loading && (
          <div className="p-3 rounded-xl bg-gray-100 text-gray-500 self-start text-sm italic max-w-[85%]" aria-busy="true">
            Thinking...
          </div>
        )}
        {itinerary && (
          <div className="w-full flex-col flex gap-2">
            <div className="p-4 rounded-xl bg-green-50 text-green-900 border border-green-200 text-sm self-start w-full">
              ...
              <details className="mt-2" aria-expanded="false">
                <summary className="cursor-pointer font-medium mb-1 line-clamp-1" aria-label="View Budget Details">View Budget Details</summary>
