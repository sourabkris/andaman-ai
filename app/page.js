...
export default function Home() {
  ...
  const handleItineraryUpdate = useCallback((newItinerary) => {
    setItinerary(newItinerary);
  }, []);

  return (
    <main className="flex flex-col h-[100dvh] w-full bg-gray-50 text-black p-3 sm:p-4 md:p-6 lg:p-8" role="main">
      ...
      {/* Mobile Tab Toggle */}
      <nav className="lg:hidden flex bg-gray-200/80 p-1 mb-3 shrink-0 rounded-xl" aria-label="Mobile Navigation">
        <button 
